...
class L10nFa extends L10n {
  ...
  @override
  String get confirmMatrixId => 'لطفاً شناسایی ماترس تان را تایید دهید تا حساب تان را حذف کنید.';
  ...
  @override
  String get areGuestsAllowedToJoin => 'آیا اجازه می‌شود کہ کاربر مہمان‌ها بپیوندند';
  ...
  @override
  String get askSSSSSign => 'تا بتوانید شخص دیگر را امضا کنید، لطفاً رمز عبور را برای حافظۂ امن وارد کنید.';
  ...
  @override
  String get autoplayImages => 'بطور خودکار اموجی و برچسب‌های سرزنده را نمایش شوند';
  ...
  @override
  String get chatBackupDescription => 'پیام‌های قدیم تان با یہ کلید باز یابی امن می‌شوند. لطفاً حتمی کنید کہ آن را گم نکنید.';
  ...
  @override
  String get commandHint_myroomavatar => 'برای این اتاق عکس پروفایل خود تنظیم کنید (با mxc-uri)';

  @override
  String get commandHint_myroomnick => 'برای این اتاق نام نمایش خود را تنظیم کنید';

  @override
  String get commandHint_op => 'درجۂ اجازۀ کاربر مشخص شده را تنظیم کنید (پیشفرض: ۵۰)';
  ...
  @override
  String get deactivateAccountWarning => 'این انجام حساب کاربری تان را خاموش خواهد کرد. این انجام بازگشتنی نیست! متمئن هستید؟';
  ...
  @override
  String get enableEncryptionWarning => 'شما دیگر قادر به غیرفعال سازی رمزگذاری نخواهید بود. آیا مطمئن هستید؟';
  ...
  @override
  String get ignoreListDescription => 'You can ignore users who are disturbing you. You won\'t be able to receive any messages or chat invites from the users on your personal ignore list.';
  ...
  @override
  String get noEncryptionForPublicRooms => 'You can only activate encryption as soon as the chat is no longer publicly accessible.';
  ...
  @override
  String get openAppToReadMessages => 'برنامہ را باز کنید تا پیام‌ها را بخوانید';
  ...
  @override
  String get showDirectChatsInSpaces => 'گپ‌های مستقیم مربوط توی اسپیس‌ها نشان دهید';
