...
@objc class AppDelegate: FlutterAppDelegate {
  var dediApnChannel: FlutterMethodChannel?
  var initialNotiInfo: Any?
  override func application(
    _ application: UIApplication,
    didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?
  ) -> Bool {
    dediApnChannel = createApnChannel()
    ...
    func createApnChannel() -> FlutterMethodChannel {
        ...
        let dediApnChannel = FlutterMethodChannel(
            name: "dedi_apn",
            binaryMessenger: controller.binaryMessenger)
        dediApnChannel.setMethodCallHandler { [weak self ] call, result in
            switch call.method {
            case "getToken":
    ...
    override func userNotificationCenter(_ center: UNUserNotificationCenter,
        ...
        dediApnChannel?.invokeMethod("willPresent", arguments: userInfo)
    ...
    override func userNotificationCenter(_ center: UNUserNotificationCenter,
        ...
        dediApnChannel?.invokeMethod("didReceive", arguments: userInfo)
        completionHandler()
    }
}
