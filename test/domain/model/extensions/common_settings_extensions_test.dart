...
void main() {
  group('CommonSettingsInformationExtension', () {
    test('completedApplicationUrl returns null when applicationUrl is null',
        () {
    ...
    test('completedApplicationUrl returns null when applicationUrl is empty',
        () {
      final commonSettings = CommonSettingsInformation(
        enabled: true,
        applicationUrl: '',
    ...
    test('completedApplicationUrl returns null when userId is invalid (no @)',
        () {
      final commonSettings = CommonSettingsInformation(
        enabled: true,
    ...
    test('completedApplicationUrl returns null when userId has @ at the end',
        () {
      final commonSettings = CommonSettingsInformation(
        enabled: true,
        applicationUrl: 'https://{username}-settings.dedim.com.tr/',
    ...
    test('completedApplicationUrl handles very long usernames and homeservers',
        () {
      final commonSettings = CommonSettingsInformation(
        enabled: true,
        applicationUrl: 'https://{username}-settings.dedim.com.tr/',
